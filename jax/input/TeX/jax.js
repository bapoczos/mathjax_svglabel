...
(function (TEX,HUB,AJAX) {
  ...
  STACKITEM.labelme = STACKITEM.Subclass({
    type: "labelme",
    checkItem: function (item) {
	console.log('**');
	console.log(item);
      ...
      if (!item.isClose) {return this.SUPER(arguments).checkItem.call(this,item)}
      //var mml = MML.mlabelme.apply(MML,this.data).With(this.labelme); 
      console.log(this.labelme);
...
//      noalign:            'HandleNoAlign',
  ...
  var PARSE = MathJax.Object.Subclass({
    ...
    LabelMe: function (name) {
      var labelname = this.GetArgument(name);
      var old = this.stack.env.labelname; this.stack.env.color = labelname;
      var math = this.ParseArg(name);
      if (old) {this.stack.env.labelname} else {delete this.stack.env.labelname}
      console.log(labelname)
      
      this.Push(MML.mlabelme(math).With({labelname:labelname})); //this line does the coloring
      console.log(math);
    },
    ...
    Color: function (name) {
      ...
      this.Push(MML.mstyle(math).With({mathcolor: color})); //this line does the coloring
    },
